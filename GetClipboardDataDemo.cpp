...
int main()
{
    ...
    endTime = clock();
    std::cout << "Obtain unicode text uses total time : "
    ...
    endTime = clock();
    std::cout << "Obtain RTF format data uses total time : "
        << (double)(endTime - startTime) / CLOCKS_PER_SEC
        << "s" << std::endl;
    std::cout << std::endl;
    ...
    endTime = clock();
    std::cout << "Obtain HTML format data uses total time : "
        << (double)(endTime - startTime) / CLOCKS_PER_SEC
        << "s" << std::endl;
    std::cout << std::endl;
...
OpenClipboardWrapper()
{
    ...
    do {
        ...
        if (result) {
            std::cout << "OpenClipboard succeeded, after trying " << retryCount + 1 << " times." << std::endl;
            break;
        }

        if ((error = GetLastError()) != ERROR_ACCESS_DENIED) {
            std::cout << "OpenClipboard failed with error = " << error << std::endl;
            break;
        }

        std::cout << "OpenClipboard failed with ERROR_ACCESS_DENIED." << std::endl;
